...
layui.define("jquery", function (e) {
    ...
    D.prototype.config = {
        ...
        format: "hex",
        predefine: !1,
        colors: ["#54b5ff", "#5FB878", "#1E9FFF", "#F55366", "#FFB800", "#01AAED", "#999", "#c00", "#ff8c00", "#ffd700", "#90ee90", "#00ced1", "#1e90ff", "#c71585", "rgb(0, 186, 189)", "rgb(255, 120, 0)", "rgb(250, 212, 0)", "#393D49", "rgba(0,0,0,.5)", "rgba(255, 69, 0, 0.68)", "rgba(144, 240, 144, 0.5)", "rgba(31, 147, 255, 0.73)"]
